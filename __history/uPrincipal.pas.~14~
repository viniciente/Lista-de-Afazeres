...
begin
  if MessageDlg('⚠️ ATENÇÃO!' + #13#13 +
                'Você tem certeza que deseja APAGAR TODAS as tarefas?' + #13 +
                'Isso vai resetar a lista inteira e não poderá ser desfeito.',
    ...
    try
      ...
      begin
        try
          ...
          on E2: Exception do
            ShowMessage('Erro crítico ao tentar limpar o banco: ' + E2.Message);
        end;
      end;
    end;
  end;
